              ...
              <>
                ...
                {images.length > 1 && (
                  <>
                    <Button
                      variant="secondary"
                      size="icon"
                      className="absolute left-2 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all duration-200 h-8 w-8 bg-background/80 backdrop-blur-sm hover:bg-background z-10"
                      onClick={prevImage}
                    >
                    ...
                    <Button
                      variant="secondary"
                      size="icon"
                      className="absolute right-2 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all duration-200 h-8 w-8 bg-background/80 backdrop-blur-sm hover:bg-background z-10"
                      onClick={nextImage}
                    >
                ...
                {images.length === 1 && (
                  <Badge
                    ...
                    className="absolute top-3 right-3 bg-black/60 text-white border-0 backdrop-blur-sm"
                  >
                    <Images className="h-3 w-3 mr-1" />1
                  </Badge>
                )}
              </>
            ) : (
